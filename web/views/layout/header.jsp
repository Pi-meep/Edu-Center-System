                ...
                <ul class="nav-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="tim-kiem?keyword=6">Lớp 6</a></li>
                            <li><a class="dropdown-item" href="tim-kiem?keyword=7">Lớp 7</a></li>
                            <li><a class="dropdown-item" href="tim-kiem?keyword=8">Lớp 8</a></li>
                            <li><a class="dropdown-item" href="tim-kiem?keyword=9">Lớp 9</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="tim-kiem?keyword=10">Lớp 10</a></li>
                            <li><a class="dropdown-item" href="tim-kiem?keyword=11">Lớp 11</a></li>
                            <li><a class="dropdown-item" href="tim-kiem?keyword=12">Lớp 12</a></li>
                        </ul>
                    </li>
