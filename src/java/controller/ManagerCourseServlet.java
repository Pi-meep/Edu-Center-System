...
//
///**
// * Servlet dùng để quản lý các chức năng liên quan đến khóa học, bao gồm:
// * - Hiển thị danh sách khóa học (tìm kiếm, lọc)
// * - Thêm mới khóa học
// * - Cập nhật khóa học
// * - Xóa khóa học
// * 
...
//     * 
//     * @param request HTTP request chứa tham số truy vấn (?action=list|edit|add|delete)
...
//    }
//    /**
//     * Hàm hỗ trợ parse BigDecimal từ string, nếu null hoặc rỗng thì trả về null.
//     *
